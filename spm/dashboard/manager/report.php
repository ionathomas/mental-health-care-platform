        ...
        <main class="content-wrapper">
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
                  ...
                  <div class="row">
                    ...
                    <div class="row makereport">
                      <div class="col-md-12 dflex">
                        <input type="button" value="Generate Report" class="btn" id="btnSub" name="btnSub" onclick="javascript: document.getElementById('formDate').submit()">
                      </div>
                    </div>
                  <form action="report.php" method="post" id="formDate">
              ...
              <div
                class="mdc-layout-grid__cell showing stretch-card mdc-layout-grid__cell--span-4-desktop mdc-layout-grid__cell--span-4-tablet pat" id="block3" >
                <div class="mdc-card info-card info-card--success">
                  <div class="card-inner">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12 pat" id="report" >
                <div class="mdc-card">
                  <div class="row">
                  ...
                  <div class="table-responsive" id="dispReport">
                    <div class="row" style="display: flex; justify-content: center;">
                      <div class="col-md-12">
                        <h6 style="color: red" id="empty" >No records found...</h6>
