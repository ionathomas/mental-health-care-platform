...
if (isset($_SESSION['UserName'])) {
  ...
  $sql = "SELECT * FROM appointment WHERE MgtUserName = '$UserName' AND patientUsername NOT IN (SELECT patientUsername FROM deletepatient) AND Date > CURRENT_DATE UNION SELECT * FROM appointment WHERE MgtUserName = '$UserName' AND Date = CURRENT_DATE AND Time >= CURRENT_TIME;";
  ...
  if ($len > 0) {
    ...
    if (isset($_POST['patientUserName'])) {
      ...
      if (mysqli_query($conn, $sql6)) {
        echo "<script>alert('Patient Deleted'); window.open('list-of-patients-assigned-to-doctor-itself.php','_self');</script>";
        exit();
      } else {
        echo "<script>alert('Error Encountered while deleting Patient. Try again later'); window.open('list-of-patients-assigned-to-doctor-itself.php','_self');</script>";
        exit();
      }
    }
  }
  ...
  $flag = 0;
  $sql4 = "SELECT * FROM appointment WHERE MgtUserName = '$UserName' AND PatientUserName NOT IN (SELECT patientUsername FROM deletepatient UNION SELECT PatientUserName FROM appointment WHERE MgtUserName = '$UserName' AND PatientUserName NOT IN (SELECT patientUsername FROM deletepatient) AND Date > CURRENT_DATE UNION SELECT PatientUserName FROM appointment WHERE MgtUserName = '$UserName' AND PatientUserName NOT IN (SELECT patientUsername FROM deletepatient) AND Date = CURRENT_DATE AND Time >= CURRENT_TIME UNION SELECT PatientUserName from pending_appointment) ORDER BY Date, Time;";
  ...
  <div class="body-wrapper">
    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      ...
      <div class="mdc-drawer__content">
        <div class="user-info">
          <p class="name" id="name">Karnik Shah (D)</p>
          <p class="email" id="email">karnik@gmail.com</p>
        </div>
      ...
      <header class="mdc-top-app-bar">
        <div class="mdc-top-app-bar__row">
          <div class="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
            ...
            <span class="mdc-top-app-bar__title" id="greeting_msg">Greetings Karnik Shah!</span>
          </div>
            ...
            <div class="menu-button-container menu-profile d-none d-md-block">
              <button class="mdc-button mdc-menu-button">
                <span class="d-flex align-items-center">
                  ...
                  <span class="user-name" id="user-full-name">Karnik Shah</span>
                </span>
              </button>
        ...
        <div class="mdc-layout-grid__inner">
          <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
            <div class="mdc-card p-0">
              <h6 class="card-title card-padding pb-2" style="font-weight: 600; margin-bottom: 20px; font-size: 22px;">
                Upcoming Consultations</h6>
                    ...
                    <table class="table table-bordered table-hover" id="table" style="visibility: hidden">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Self Assesment Score</th>
                      ...
                      <tbody id="table-body">
                        <!-- <tr>
                              ...
                              <td style="width: 15%;">Counselor name</td>
                              <td style="width: 12%;">10/10</td> -->
                        <!-- <td style="width: 14%;">
                                <div class="dropdown">
                                  <select id="doctor">
                        ...
                        <!-- <td style="width: 10%;">
                                <a href="specific_patient-for-doctors.html">View More</a> -->
              ...
              <div id="followUp" style="visibility: hidden">
                <h6 class="card-title card-padding pb-2" style="font-weight: 600; margin-bottom: 20px; font-size: 22px;"
                  id="follow">Follow-up Consultations</h6>
                <div class="table-responsive">
                  <div class="row" style="display: flex; justify-content: center;">
                    <div class="col-md-12">
  ...
  <script>
    ...
    function displayPast() {
      ...
      for (i = idx2; i < idxLen; i++) {
        ...
        str += '<td style="width: 12%;">' + setTime[i] + '</td>'
        str += '<td style="width: 10%;"><a href="javascript: patient(' + i + ')" id="view">View More</a>'
        str += '<form id="' + i + '" method="POST" action="specific_patient-for-doctors.php">'
        str += '<input type="hidden" id="name" name="name" value="' + FullName[i] + '">'
        str += '<input type="hidden" id="username" name="username" value="' + userName[i] + '">'
        str += '<input type="hidden" id="score" name="score" value="' + score[i] + '"></form>'
        str += '</td>'
