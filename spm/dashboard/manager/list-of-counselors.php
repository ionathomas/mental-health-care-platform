<?php
    ...
    if(isset($_SESSION['UserName'])){
        ...
        $sql = "SELECT * FROM counselor ORDER BY FullName";
        $result = mysqli_query($conn, $sql);
        $len = mysqli_num_rows($result);

        //echo $len;
        if($len <= 0){
          echo "<script>alert('Counselor list missing. Try again later'); window.open('../../../index.php','_self');</script>";
        }
        else{
          $name = array();
          $email = array();
        ...
        if(isset($_POST['UserName'])){
          $counselorUn = $_POST['UserName'];
          $sql6 = "DELETE FROM counselor WHERE UserName = '$counselorUn'";
          $sql7 = "UPDATE patient SET Assigned=0 WHERE UserName IN (SELECT PatientUserName from assignpatient WHERE AdminUserName = '$counselorUn') OR UserName IN (SELECT PatientUserName from appointment WHERE MgtUserName = '$counselorUn')";
          if(mysqli_query($conn,$sql6) && mysqli_query($conn, $sql7)){
            echo "<script>alert('Counselor Deleted'); window.open('list-of-counselors.php','_self');</script>";
            exit();
          }
          else{
            echo "<script>alert('Error Encountered while deleting Counselor. Try again later'); window.open('list-of-counselors.php','_self');</script>";
            exit();
          }
        }
  ...
  <div class="body-wrapper">
    ...
    <div class="main-wrapper mdc-drawer-app-content">
              ...
              <div class="mdc-menu mdc-menu-surface" tabindex="-1">
                <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    ...
                    <a href="../../login.php"><div class="item-content d-flex align-items-start flex-column justify-content-center">
              ...
              <div class="mdc-menu mdc-menu-surface" tabindex="-1">
                <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                  <li class="mdc-list-item" role="menuitem">
                    ...
                    <a href="../../logout"><div class="item-content d-flex align-items-start flex-column justify-content-center">
                      <h6 class="item-subject font-weight-normal">Logout</h6>
                    </div></a>
                  </li>
                </ul>
      ...
      <div class="page-wrapper mdc-toolbar-fixed-adjust">
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-2" style="font-weight: 600; margin-bottom: 20px; font-size: 22px;">List of Counselors</h6>
                      ...
                      <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-hover" id="table">
                          ...
                          <!--<tr>
                              ...
                              <!--</td>
                              <td style="width: 10%;">
                                <button type="button" class="btn delete" data-toggle="modal" data-target="#cdel">
                                  <i class="fas fa-trash"></i>
                                </button>
                                <div class="modal fade deletecontent" id="cdel" tabindex="-1" role="dialog"
                                      ...
                                      <div class="modal-body">
                                        <div class="row">
                                          <div class="col-md-12">
                                            ...
                                            <h4>Are you sure?</h4>
                                            <p>Do you really want to delete the record of this Counselor?<br>This process cannot be undone.</p>
                                          </div>
                                        </div>
        ...
        <form id="deletePatient" method="post" action="list-of-counselors.php">
  ...
  <script>
    ...
    function displayList(){
      ...
      for(i=0;i<len;i++){
        ...
        str+='<p>Do you really want to delete the record of this counselor?<br>This process cannot be undone.</p>'
        str+='</div>'
        str+='</div>'
        str+='</div>'
