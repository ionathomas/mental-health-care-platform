<?php
    ...
    if(isset($_SESSION['UserName'])){
        ...
        $sql="SELECT * FROM assignpatient WHERE AdminUserName = '$UserName' AND PatientUserName NOT IN (SELECT PatientUserName FROM assignPatient WHERE AdminCategory = 'D' UNION SELECT PatientUserName FROM appointment UNION SELECT PatientUserName FROM deletepatient);";
        $result1=mysqli_query($conn, $sql);
        $new_patients_len=mysqli_num_rows($result1);

        $sql2="SELECT * FROM assignpatient WHERE AdminUserName = '$UserName' AND PatientUserName NOT IN (SELECT PatientUserName FROM assignPatient WHERE AdminCategory = 'D' UNION SELECT PatientUserName FROM deletepatient)";
            ...
            <div
                ...
                <div class="mdc-card info-card info-card--success">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight pb-2 mb-1 border-bottom hsize" id="new_patients">2</h5>
                    <a href="list-of-patients-assigned-to-counselor-main.php">
                      <p class="tx-14 text-muted">View </p>
                    </a>
              ...
              <div
                ...
                <div class="mdc-card info-card info-card--danger">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight pb-2 mb-1 border-bottom hsize" id="assigned_patients">2</h5>
                    <a href="list-of-patients-assigned-to-counselor-itself.php">
                      <p class="tx-14 text-muted">View </p>
                    </a>
                    <div class="card-icon-wrapper">
