<?php
    ...
    if(isset($_SESSION['UserName'])){
        ...
        $sql1="SELECT * FROM patients WHERE Assigned = '0'";
        $sql2="SELECT distinct PatientUserName FROM assignpatient";
        $result1=mysqli_query($conn, $sql1);
        $unassigned_patients_len=mysqli_num_rows($result1);
        $result2=mysqli_query($conn, $sql2);
        $assigned_patients_len=mysqli_num_rows($result2);

        echo $unassigned_patients_len;
        echo $assigned_patients_len;
      ...
      <div class="mdc-drawer__content">
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link bell" href="report.php">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon"
                  aria-hidden="true">description</i>
                Report
              </a>
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card nopadd">
                  ...
                  <form action="report1.php" id="generatereport" method="post" autocomplete="on" name="report-generation">
                    <div class="row makereport" style="justify-content: center;">
                      <div class="col-md-3 dflex">
                        <input type="text" onfocus="(this.type='date')" id="startdate" name="startdate" placeholder="Start Date" required>
                        <!-- <p><b>Start Date: </b></p>
                      ...
                      <div class="col-md-3 dflex">
                        <!-- <p><b>End Date: </b></p> -->
                        <input type="text" onfocus="(this.type='date')" id="enddate" name="enddate" placeholder="End Date" required>
                      </div>
                    </div>
                    <!-- </form> -->
                    <div class="row makereport">
                      <div class="col-md-12 dflex">
                        <button type="submit" class="btn" id="myButton" onclick="displayList()">Generate Report</button>
                      </div>
                    </div>
                  </form>
                        ...
                        <table class="table table-bordered table-hover" >
                          <thead>
                            <tr>
                              ...
                              <th scope="col" style="width: 25%;">Patient Details</th>
                              <th scope="col" style="width: 16%;">Self Assessment Score</th>
                              <th scope="col" style="width: 22%;">Date</th>
                              <th scope="col" style="width: 25%;">Counselor/Doctor Details</th>
                            </tr>
                          </thead>
                          <tbody id="mineTable">
                            <tr>
                              ...
                              <td ><span class="fwbold">10/10</span><br><a href="specific_patient-for-manager.html">View More</a></td>
              ...
              <div
                ...
                <div class="mdc-card info-card info-card--success">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light hsize">2</h5>
              ...
              <div
                class="mdc-layout-grid__cell showing stretch-card mdc-layout-grid__cell--span-4-desktop mdc-layout-grid__cell--span-4-tablet pat" style="display: none;">
                <div class="mdc-card info-card info-card--success">
                  <div class="card-inner">
                    <h5 class="card-title">Total Number of Counselors</h5>
                    <h5 class="font-weight-light hsize">2</h5>
                    <!-- <a href="list-of-patients.html">
                      <p class="tx-12 text-muted">View </p>
                      <i class="fa fa-arrow-right" aria-hidden="true"></i>
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12 pat" style="display: none;">
                <div class="mdc-card">
                  <div class="row">
...
document.getElementById("specPatient").submit();
    ...
    //   const divs = document.querySelectorAll('.pat');
