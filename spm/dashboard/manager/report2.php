  ...
  <div class="body-wrapper">
    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      ...
      <div class="mdc-drawer__content">
        <div class="user-info">
          <p class="name" id="name">Joy</p>
          <p class="email" id="email">Joy@healthcare.com</p>
        </div>
      ...
      <header class="mdc-top-app-bar">
        <div class="mdc-top-app-bar__row">
          <div class="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
            ...
            <span class="mdc-top-app-bar__title" id="greeting_msg">Greetings Joy!</span>
          </div>
            ...
            <div class="menu-button-container menu-profile d-none d-md-block">
              <button class="mdc-button mdc-menu-button">
                <span class="d-flex align-items-center">
                  ...
                  <span class="user-name" id="user-full-name">Joy</span>
                </span>
              </button>
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card nopadd">
                  ...
                  <form action="report-IRT.php" method="post" id="formDate">
                        ...
                        <table class="table table-bordered table-hover">
                          ...
                          <tbody id="table-body">
                            <tr>
                              ...
                              <td>12-12-2000</td>
                              <td>10/10</td>
                              <td><a href="specific_patient-for-manager.php">View
                                  More</a></td>
                            </tr>
                          </tbody>
                        </table>
